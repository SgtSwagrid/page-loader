...
lazy val `page-loader-common` = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(
    ...
    libraryDependencies +=
      "com.alecdorrington" %%% "asset-loader-common" % "0.2.5",
  )
...
lazy val `page-loader-tapir` = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir"   %% "tapir-core"               % "1.13.29",
      "com.softwaremill.sttp.tapir"   %% "tapir-prometheus-metrics" % "1.13.29",
      "com.softwaremill.sttp.tapir"   %% "tapir-swagger-ui-bundle"  % "1.13.29",
...
lazy val `page-loader-tapir-common` = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(
    packagePrefix := "com.alecdorrington.pageloader.tapir",
    libraryDependencies ++= Seq(
      "com.alecdorrington"          %%% "asset-loader-tapir-common" % "0.2.5",
