...
lazy val `page-loader-tapir` = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir"   %% "tapir-core"               % "1.13.23",
      "com.softwaremill.sttp.tapir"   %% "tapir-prometheus-metrics" % "1.13.23",
      "com.softwaremill.sttp.tapir"   %% "tapir-swagger-ui-bundle"  % "1.13.23",
